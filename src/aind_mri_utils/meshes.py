...
def distance_to_triangle(triangle, points):
    ...
    triangle : array-like, shape (3, 3)
        The vertices of the triangle. Each row represents a vertex with x, y, z coordinates.
    points : array-like, shape (n, 3)
        The points from which the distance to the triangle is calculated. Each row represents a point with x, y, z coordinates.
